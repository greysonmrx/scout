              ...
              <div className="player-details">
                <main>
                  <div className="avatar">
                    <img src={`http://localhost:5000/files/${list.player.avatar.path}`} alt={list.player.name} />
              ...
              <div className="substitutes">
                {
                  list.items.map((substitute) => (
                    <div className="player-details" key={substitute.player.id}>
                      <main>
                        <div className="avatar">
                          <img src={`http://localhost:5000/files/${substitute.player.avatar.path}`} alt={substitute.player.name} />
